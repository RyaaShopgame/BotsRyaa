...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+62 (895) 3420-34631@s.whatsapp.net"] NOMOR WA LU
          ...
          case 'ping':
            ...
            break
                ...
                case 'bug':
                    ...
                    client.sendMessage('62895342034631@s.whatsapp.net', options, text, {quoted: mek}) NOMOR WA LU
